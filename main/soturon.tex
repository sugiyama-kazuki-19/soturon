...
そこで，一定誤差のズレを許容する“大雑把に粗く見積もる視点”を導入し，局所的な違いを無視することで，大局的な部分だけを見比べ，群の本質的な構造を抽出することができる．擬等長写像(quasi-isometric)とは，距離空間から距離空間への写像であり，送った先の二点間の距離が，送る前の二点間の距離の定数倍と定数項で抑えられるようなものを指す．これによって二つの距離空間の大局的な構造を見比べることができ，Cayleyグラフの生成系に依存してしまう問題を解決できる．
