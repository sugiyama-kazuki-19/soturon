...
群に距離を導入し，距離空間として考えることで，幾何学的対象である距離空間への群作用から構造を考察することができるようになる．Cayleyグラフから自然と得られる距離を導入し，距離空間への群作用を見ることで，群作用をしている距離空間と，群が同じような構造を持っていることが分かるようになる．この際，Cayleyグラフは生成系に依存してしまうため，群に導入した距離関数も生成系に依存してしまう．そこで，一定誤差のズレを許容する“粗く見積もる視点”を導入することで，この問題を解決できる．
