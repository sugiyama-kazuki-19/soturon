...
\caption{Cayleyグラフ の例}
\label{cayleyZ2}
\end{figure}

Cayleyグラフとは，群の元を頂点とし，生成系の元で辺を結ぶことで得られるグラフであり，生成系によってグラフの形は変わるものの，生成系込みでの群の構造を可視化することに長けている．特に自由群に関しては相性が良く，そのCayleyグラフは tree になることが知られている．逆に，適切な条件下であれば，群と生成系に関するCayleyグラフが tree のとき，群は自由群であることも知られており，このことから自由群の部分群が自由群になるスマートな証明も与えられる．

\textcolor{red}{群作用について書く}

Cayleyグラフから得られる距離を群に導入することで，群を距離空間として捉えることができる．そして他の距離空間への群作用を見ることで，群作用をしている距離空間の構造と，もともとの群の構造の類似性を考察することができる．例えば，上の図 \ref{cayleyZ2} では，$\mathbb{Z}^2$ の Cayleyグラフは，距離空間 $\mathbb{R}^2$ のような広がりを持っていることが視覚的に理解できる．そのため，$\mathbb{Z}^2$ という群の構造は，$\mathbb{R}^2$ という空間と同じような構造を持っていることが分かる．しかしこの際，Cayleyグラフの構造は生成系に依存してしまうため，群に導入した距離関数も生成系に依存してしまう．
...
本論文では \cite{1} の議論をもとに，Švarc-Milnor Lemma の証明と，その補題を位相空間論の視点で言い換えた主張の証明を与えることを主目的としている．\ref{sec_jyunbi} 章にて必要な用語の定義を行い，\ref{sec_hodai} 章にて Švarc-Milnor Lemma の証明，\ref{sec_ouyou} 章にて，主補題の位相空間論版を紹介，証明を行う．なお，幾何学的群論における Cayleyグラフ などの基本的概念は付録としてまとめているので，そちらを参照されたい．
...
\begin{align*}
  ...
  (0,1)\cdot (x,y) = (x,y+2)
\end{align*}
からなる作用をしているとする．作用の仕方からこれは等長な群作用である．$\mathbb{R}^2$ を $(1,1/2)$-擬測地的距離空間とし，部分集合 $B\subset \mathbb{R}^2$ を，
...
\appendix
\section{付録}
ここでは幾何学的群論の分野にて基本的な概念となる Cayleyグラフ や，その周辺の事項について述べる．なおここで述べるグラフとは，多重辺やループは許していないことに注意．
\subsection{Cayley Graphs}
群からできる Cayleyグラフ とは，その生成系を用いて群の構造を可視化することを目的としており，幾何学的群論では幅広く用いられている．たくさんの重要な性質を持っているが，ここではその定義と特徴的な定理の紹介に留める．
