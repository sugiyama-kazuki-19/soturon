...
幾何学的群論とは，群の構造や性質を幾何学的な対象を通して考察する分野である．群から幾何学的対象を構成する，あるいは他の幾何学的対象への群作用をみることで，群の代数的性質や幾何学的性質を見ることができるようになる．

群から幾何学的対象を構成する代表的な例としては，群とその生成系からなるCayleyグラフが挙げられる．これは，群の元を頂点とし，生成系の元で辺を結ぶことで得られるグラフであり，生成系に依存はするものの生成系込みでの群の構造を可視化することに秀でている．特に自由群に関しては相性が良く，そのCayleyグラフは tree になることが知られている．またこのことから，自由群の部分群が自由群になるスマートな証明も与えられる．

群に距離を導入し距離空間として考えることで，幾何学的対象である距離空間への群作用から，群の構造を考察することができるようになる．Cayleyグラフから自然と得られる距離を導入し，距離空間への群作用を見ることで，群作用をしている距離空間と群が同じような構造を持っていることが分かるようになる．この際，Cayleyグラフは生成系に依存してしまうため，群に導入した距離関数も生成系に依存してしまう．そこで，一定誤差のズレを許容する“大雑把に粗く見積もる視点”を導入することで，この問題を解決できる．
