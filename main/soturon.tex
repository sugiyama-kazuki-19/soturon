...
Cayleyグラフとは，群の元を頂点とし，生成系の元で辺を結ぶことで得られるグラフであり，生成系によってグラフの形は変わるものの，生成系込みでの群の構造を可視化することに長けている．特に自由群に関しては相性が良く，そのCayleyグラフは tree になることが知られている．逆に，適切な条件下であれば，群と生成系に関するCayleyグラフが tree のとき群は自由群であることも知られており，このことから自由群の部分群が自由群になるスマートな証明も与えられる．また，Cayleyグラフは群が作用する空間の代表例と言える．実際，群は自身のCayleyグラフの頂点集合に対して，左からの演算で群作用をなす．この群作用は，サイクルなどのグラフの構造を保つため，Cayleyグラフの構造を群作用を通して理解することもできる．そのため，幾何学的群論ではしばしば群作用に着目することが多い．
...
\appendix
\section{付録}
ここでは幾何学的群論の分野にて基本的な概念となるCayleyグラフや，その周辺の事項について述べる．なおここで述べるグラフとは，多重辺やループは許していないことに注意．\textcolor{red}{もう少し取捨選択して書く。内容が著しく増えるようであれば本編に回すのもアリ}
...
\begin{ex}
 \textcolor{red}{$\mathbb{Z}^2$ のCayleyグラフとか}
\end{ex}
