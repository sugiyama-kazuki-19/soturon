...
群 $G$ が，よい性質を持った距離空間 $X$ に群作用をなし，この群作用が次の3条件：(1) 距離を保つ群作用である． (2) 直径が有限のある部分集合 $B\subset X$ がとれ， $G$ の作用で $X$ 全体を覆える．(3) $B$ を少し大きくした集合 $B^\prime$ と，$B^\prime$ を群作用で移した集合 $g\cdot B^\prime$が互いに素でないような $g\in G$ が有限である．
...
\noindent
[2] Bridson-Haefliger, \textit{Metric Spaces of Non-Positive Curvature}, Springer, 1999.
