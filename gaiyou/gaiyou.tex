...
本研究では補題の証明と，コンパクトなリーマン多様体という具体的な幾何構造を持つ空間に適用した例をまとめた．今後は他の具体的な幾何構造をもつ空間 (負極率をもつ空間など) に適応した例を考え，研究・理解を深めたい．
